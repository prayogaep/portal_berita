<nav class="bg-white shadow-md border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        <a href="/" class="flex items-center">
            <span class="self-center text-xl font-semibold whitespace-nowrap ml-8">Portal Berita</span>
        </a>
        ...
        @auth
            ...
            <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar-search">
                ...
                <ul
                    ...
                    <li>
                        <a href="/"
                            class="block py-2 pr-4 pl-3 bg-blue-700 rounded md:bg-transparent {{ Request::is('/') ? 'md:text-blue-700'  : 'text-gray-700'}} md:p-0 dark:text-white"
                    ...
                    {{-- <li>
                        <a href="/categories"
                            class="block py-2 pr-4 pl-3  {{ Request::is('categories') ? 'md:text-blue-700'  : 'text-gray-700'}} rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Categories</a>
                    </li> --}}
                    <li>
                        <a href="/tags"

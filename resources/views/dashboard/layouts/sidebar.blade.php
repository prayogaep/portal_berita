<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
                <span class="ms-3 badge bg-secondary"> Hi, {{ Auth::user()->profile->nama }}</span>
          </li>
          <hr>
          <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Request::is('dashboard/profile*') ? 'active' : '' }}" href="/dashboard/profile/{{ base64_encode(Auth::user()->id) }}">
